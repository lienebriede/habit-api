...
|POST `/habit-stacking/`|Create habit stacks with a "DAILY" goal and see logs created automatically.| 7 logs for the next 7 days are created, each with `completed=False` by default.||
